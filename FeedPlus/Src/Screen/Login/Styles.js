...
const Styles = {
    ...
    subtext:{fontFamily:fonts.PoppinsLight,color:'grey',fontSize:FontsSize.size14,alignSelf:'flex-start',marginVertical:MarginHW.MarginH20,paddingLeft:MarginHW.MarginW22},
